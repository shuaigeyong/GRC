...
<html>
    ...
    <body>
        <div id="sidebar" class="sidebar">
            ...
            <a href="member_list.php" class="icon-a"><i class="fa fa-users icons"></i>&nbsp;&nbsp;Member</a>
            <a href="banned_list.php" class="icon-a"><i class="fa fa-solid fa-ban icons"></i>&nbsp;&nbsp;Banned List</a>
            <a href="../Movie_management_module/movielist.php" class="icon-a"><i class="fa fa-solid fa-film icons"></i>&nbsp;&nbsp;Movie</a>
            <a href="../Genre_management_module/genrelist.php" class="icon-a"><i class=" fa fa-light fa-ticket icons"></i>&nbsp;&nbsp;Genre</a>
